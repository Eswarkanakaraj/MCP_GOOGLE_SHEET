  ...
  return {
    tools: [
        ...
        inputSchema: {
          ...
          properties: {
            range: {
              type: "string",
              description:
                "The A1 notation of the values to update. e.g., 'Sheet1!A2:C2'",
            },
            values: {
              type: "array",
              items: { type: "string" },
              description:
                "Array of string values to insert into the cells in the range. Example: ['100', 'Completed', 'Done']",
            },
          },
      ...
      },
      {
        ...
        description:
          "Updates formatting (e.g., font family) of cells in a Google Sheet.",
        inputSchema: {
          type: "object",
          properties: {
            fontFamily: {
              type: "string",
              description:
                "The font family name to apply. e.g., 'Times New Roman'",
            },
            sheetId: {
              type: "integer",
      ...
      },
      {
        ...
        description:
          "Applies data validation dropdown rules to a specific column range in Google Sheets.",
        inputSchema: {
          type: "object",
          properties: {
            sheetId: {
            ...
            startRowIndex: {
              type: "integer",
              description:
                "Starting row index (0-based). Default is 2 (Row 3).",
            },
            endRowIndex: {
              type: "integer",
            ...
            columnIndex: {
              type: "integer",
              description:
                "The 0-based column index to apply validation to (e.g., 7 for Column H, 8 for Column I).",
            },
            options: {
              type: "array",
              items: { type: "string" },
              description:
                "Array of allowed string options. Example: ['Completed', 'Pending', 'In Progress']",
            },
          },
      ...
      },
      {
        ...
        description:
          "Removes data validation rules from a specific column range in Google Sheets.",
        inputSchema: {
          type: "object",
          properties: {
            sheetId: {
            ...
            startRowIndex: {
              type: "integer",
              description:
                "Starting row index (0-based). Default is 56 (Row 57).",
            },
            endRowIndex: {
              type: "integer",
              description: "Ending row index. Default is 1000.",
            ...
            columnIndex: {
              type: "integer",
              description:
                "Column index to remove validation from (e.g., 7 for H, 8 for I).",
            },
          },
        ...
        inputSchema: {
          ...
          properties: {
            title: {
              type: "string",
              description:
                "The title of the new sheet tab. e.g., 'Remarks Sheet 2'",
            },
          },
          required: ["title"],
        },
        ...
        inputSchema: {
          ...
          properties: {
            range: {
              type: "string",
              description:
                "The A1 notation of the values to read. e.g., 'Sheet1!A1:Z100'",
            },
          },
          required: ["range"],
        },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  if (
    request.params.name === "read_google_sheet" ||
    request.params.name === "update_google_sheet" ||
    request.params.name === "format_google_sheet" ||
    request.params.name === "add_dropdown_validation" ||
    request.params.name === "remove_dropdown_validation" ||
    request.params.name === "create_sheet_tab"
  ) {
    try {
      ...
      if (request.params.name === "read_google_sheet") {
